const translations = {
    en: {
        ...
        "demo.subtitle": "Drag over the text below to see how ScreenTranslate works.",
        "demo.hint": "Drag to select text",
    ...
    ko: {
        ...
        "demo.title": "직접 체험해 보세요",
        "demo.subtitle": "아래 텍스트 위를 드래그하여 ScreenTranslate의 동작을 확인하세요.",
        "demo.hint": "드래그하여 텍스트 선택",
